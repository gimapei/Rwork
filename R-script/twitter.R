...
apiKey <-  "cEBaEAEp5nLrmWCkfpxEgi1TO" 
apiSecret <- "KTpjRKPbqQsPXpbIZiQNfugYtyu28QtFRsOTvPcqA9xeVM9icl" 
accessToken="632641860-oXmXwDRxvzxu6yqL1znn2NiJG38lyN24IXUczFDW"
accessTokenSecret="os72ikAWzrhIbqMpMDWZvU6qsxRxxs7rJhXA1cwQjMNIy"
...
# 콘솔 창에 인증 코드(PIN) 붙여넣기 -> 엔터 -> 인증수행 스크립트 실행 
