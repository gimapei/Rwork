...
drv <- JDBC(driverClass="com.mysql.jdbc.Driver", 
    classPath="C:/Rwork/util/mysql-connector-java-5.1.38-bin.jar")
...
# 10. table 레코드 삭제 
delquery = "delete from goods where code=5"
...
# 문) 다음과 같이 data frame을 생성하시오.
# code name    su  dan      su * dan
#   1  냉장고  2  850000   1700000
#           :                :
#   4  HDVT    2  1500000  3000000 
